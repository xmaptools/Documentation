...
XMapTools is distributed via shell scripts for [macOS](/installation_guide#macos) and [Windows](/installation_guide#windows) that automate the installation, update, download, extraction, and configuration of the program.
